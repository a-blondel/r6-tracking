...
public class TabSettings extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public static final String[] SEASONS_LIST = new String[]{"SHIFTING TIDES", "EMBER RISE", "PHANTOM SIGHT", "BURNT HORIZON", "WIND BASTION", "GRIM SKY", "PARA BELLUM", "CHIMERA", "WHITE NOISE", "BLOOD ORCHID", "HEALTH"};
    public static final List<Integer> SEASONS_ID_LIST = new ArrayList<>(Arrays.asList(16, 15, 14, 13, 12, 11, 10, 9, 8, 7, 6));
