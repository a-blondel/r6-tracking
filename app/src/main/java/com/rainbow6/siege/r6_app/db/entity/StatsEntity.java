...
public class StatsEntity {
    ...
    public StatsEntity(@NonNull int id, String profileId, Date updateDate, int timePlayedRanked, int matchWonRanked, int matchLostRanked, int killsRanked, int deathRanked, int timePlayedCasual, int matchWonCasual, int matchLostCasual, int killsCasual, int deathCasual) {
        this.id = id;
