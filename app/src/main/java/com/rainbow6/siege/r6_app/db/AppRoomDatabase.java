...
@Database(entities = {ConnectEntity.class, GeneralEntity.class,PlayerEntity.class, ProgressionEntity.class, SkillEntity.class, StatsEntity.class, SynchEntity.class},
        version = 4)
            ...
            synchronized (AppRoomDatabase.class) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                            AppRoomDatabase.class, "rainbow_database")
                            .build();
