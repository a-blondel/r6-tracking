...
public class SynchEntity {
    ...
    public SynchEntity(@NonNull String profileId, boolean synchEmea, boolean synchNcsa, boolean synchApac, int synchDelay, boolean synchGeneral, boolean synchStats) {
