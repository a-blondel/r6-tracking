...
public class GeneralEntity {
    ...
    public GeneralEntity(@NonNull int id, String profileId, Date updateDate, int timePlayed, int matchWon, int matchLost, int kills, int death, int headshots, int bulletHit, int bulletFired, int killAssists) {
        this.id = id;
